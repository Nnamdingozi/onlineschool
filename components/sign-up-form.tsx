...
//           emailRedirectTo: `${window.location.origin}/auth/confirm?next=/protected/class`
...
//         password,
        ...
        //     grade_id: gradeIdNumber, // 👈 stored in raw_user_meta_data
        //   },
//         },
//       });
...
// console.log('grade Id number after signup:', gradeIdNumber)
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error } = await supabase.auth.signUp({
        email,
        password,
        options: {  emailRedirectTo: `${window.location.origin}/protected/class`,
      ...
      // 👇 No need to insert into profiles — trigger will handle it
      router.push("/auth/sign-up-success");
